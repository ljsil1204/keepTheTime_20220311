...
import com.example.keepthetime_20220311.adapters.RequestedUsersRecyclerAdapter
...
class RequestedUsersFragment : BaseFragment() {
    ...
    lateinit var mRequsetUserAdapter : RequestedUsersRecyclerAdapter
...
//        API : getRequestFriendList 함수 -> "requested" 로 대입.
        ...
        mRequsetUserAdapter = RequestedUsersRecyclerAdapter(mContext, mRequestUserList)
        binding.requestUsersRecyclerView.adapter = mRequsetUserAdapter
        ...
        apiList.getrequestFriendList("requested").enqueue(object : Callback<BasicResponse>{
            override fun onResponse(call: Call<BasicResponse>, response: Response<BasicResponse>) {
                ...
                if (response.isSuccessful){
                    ...
                    mRequsetUserAdapter.notifyDataSetChanged()
