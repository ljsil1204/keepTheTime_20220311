...
import com.example.keepthetime_20220311.adapters.StartPlaceSpinnerAdapter
...
//            binding.startPlaceSpinner.selectedItemPosition // 지금 선택되어이쓴 아이템이 몇번째 아이템인지.
...
//        출발지와 / 도착지 모두 불러와져야 진행
        if (mSelectedStartPlace == null || mSelectedLatLng == null) {
            return // 좌쵸가 하나라도 없으면 강제 종료
        }

        val myODsayService = ODsayService.init(mContext, "2ZUL48uEwaiRd+EIpRbEVg2bSQS/bZnhQXCDOqczKlM")
...
//                            네이버 지도 라이브러리의 InfoWindow 기능 활용.
                    ...
                    infoWindow.adapter = object : InfoWindow.DefaultTextAdapter(mContext) {
                        ...
                        override fun getText(p0: InfoWindow): CharSequence {
                            return "총 이동시간 : ${totalTime}분, 비용 : ${payment}원"
                        }
